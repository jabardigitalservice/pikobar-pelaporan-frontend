...
export default {
  ...
  label: {
    ...
    examination_result_date: 'Tanggal Hasil Pemeriksaan',
    reporting_sources: 'Sumber Pelaporan',
    sender_instation: 'Instansi Pengirim',
    ...
    details_examination_results: 'Detail Hasil Pemeriksaan',
    create_pe_report: 'Buat Laporan PE',
    action: 'Aksi',
    ...
    list_positive_examination_results: 'Daftar Hasil Pemeriksaan Positif',
